  ...
  <div class="px-16 py-12">
    <div class="flex">
      <div class="mr-16 flex-shrink-0" style="width:30rem;">
        <h2 class="text-24 font-bold mb-4">Bathtub Doors</h2>
          ...
          <div v-if="subCategory.id === selectedSubcategory">
            ...
            >
              ...
              <div class="flex px-12 w-full border-box flex-wrap">
                <div class="w-1/2 border-box pb-8">
...
export default {
  ...
  methods: {
    ...
    filterDescriptionByGlassColor(index) {
      let glassColor = this.items[this.selectedSubcategory][index].glass_color_id;
      ...
      this.products[this.selectedSubcategory].forEach(product => {
        ...
        this.items[this.selectedSubcategory][index].descriptions = filteredDescriptions;
    },
    ...
    setupPreviousQuoteItems() {
      let quoteItems = this.quote.items.filter(
        item => item.product_category_id === 8
      );
      quoteItems.forEach(quoteItem => {
        ...
        const description = `${doorType.value} with ${thickness.value} thick glass`;
